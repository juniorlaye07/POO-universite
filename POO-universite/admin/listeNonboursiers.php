...
<html>
    ...
    <body style="background-image:url(about-lg.jpg)">
        <h1 class="text-logo"><span ></span> Liste des Non Boursiers <span ></span></h1>
        <div class="container admin">
            <div class="row">
                <h1><strong>Non Boursiers:   </strong><a href="Ajoute-Etudiant.php" class="btn btn-primary btn-lg" style="background-color: #218095"><span class="glyphicon glyphicon-plus"></span> Ajouter Etudiants</a>
                ...
                <table id="nonBoursiers" class="table table-striped table-bordered" >
                  <thead >  
                    <tr>
                      <th>Matricule</th>
                      <th>Nom</th>
                  ...
                  <tbody>
                    <?php
                     function chargerClass($classe){
                      ...
                      foreach($gestion->findAllNon_boursier() as $apprenant) 
                      {
                         echo'<tr>
                         <td> BN'. $apprenant->Matricule.'</td>
                         <td>'. $apprenant->Nom.'</td>
